    ...
    <section className="bg-[#0D0C11] w-full max-w-[1440px] mx-auto py-[84px] px-[135px]">
      <div className="text-center max-w-4xl mx-auto flex flex-col gap-6">
        ...
        <p className="font-['Figtree',sans-serif] font-normal text-[18px] leading-[28px] text-[rgba(255,255,255,0.6)] max-w-3xl mx-auto">
          Most crypto tools expect users to know commands, interfaces, and trading flows. Zyra removes all of that. You can simply speak or type what you want to do and Zyra converts it into real on-chain transactions behind the scenes. No learning curve, no dashboards to master, no confusing steps. Just say it, review it, and execute.
        </p>
      </div>
    </section>
  );
