  ...
  <div className="flex items-center self-end gap-4">
            {isConnected && address && (
              <div className="relative">
                ...
                >
                  {/* User Icon SVG */}
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><circle cx="12" cy="8" r="4"/><path d="M6 20v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/></svg>
                  <span className="hidden text-sm md:inline-block">{address.slice(0, 6)}...{address.slice(-4)}</span>
                </button>
                {showDropdown && (
