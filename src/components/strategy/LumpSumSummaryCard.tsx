...
import { LumpSumSummary } from "@/types/lumpsum";

interface LumpSumSummaryCardProps {
  summary: LumpSumSummary;
  coinSymbol?: string;
}

const LumpSumSummaryCard: React.FC<LumpSumSummaryCardProps> = ({
  summary,
  coinSymbol = "Token",
}) => {
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-600/5 border border-blue-500/20 p-3">
            ...
            <p className="text-sm font-bold text-white">
              ${formatNumber(summary.buy_price, 4)}
            </p>
          ...
          <div className="rounded-xl bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/20 p-3">
            ...
            <p className="text-sm font-bold text-white">
              {formatNumber(summary.tokens_bought, 2)}
            </p>
...
export default LumpSumSummaryCard;
