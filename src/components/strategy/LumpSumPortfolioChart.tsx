...
interface LumpSumPortfolioChartProps {
  portfolioValues: Array<[number, number]>;
  totalInvestment: number;
}

const LumpSumPortfolioChart: React.FC<LumpSumPortfolioChartProps> = ({
  portfolioValues,
  totalInvestment,
}) => {
    ...
    <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-br from-[#05060E]/95 via-[#0A0B15]/95 to-[#05060E]/95 p-5 shadow-[0_20px_60px_rgba(5,6,14,0.8)]">
      ...
      <div className="relative z-10">
        ...
        <div className="relative w-full" style={{ height: "320px" }}>
          ...
          >
            <defs>
              <linearGradient id="lumpSumPortfolioGradient" x1="0%" y1="0%" x2="0%" y2="100%">
            ...
            {pathPoints && (
              <polygon
                ...
                fill="url(#lumpSumPortfolioGradient)"
              />
            )}
...
export default LumpSumPortfolioChart;
