...
import { DcaProjections } from "@/types/dca";

interface DcaProjectionCardProps {
  projections: DcaProjections;
}

const DcaProjectionCard: React.FC<DcaProjectionCardProps> = ({
  projections,
}) => {
          ...
          <div className="space-y-3">
            <div className="rounded-xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20 p-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-white">
                  {formatPrice(projections.mc.pct_90)}
                </span>
              </div>
            </div>
            ...
            <div className="rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-600/5 border border-blue-500/20 p-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-white">
                  {formatPrice(projections.mc.pct_50)}
                </span>
              </div>
            </div>
            ...
            <div className="rounded-xl bg-gradient-to-br from-red-500/10 to-red-600/5 border border-red-500/20 p-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-white">
                  {formatPrice(projections.mc.pct_10)}
                </span>
              </div>
            </div>
          </div>
...
export default DcaProjectionCard;
